...
var Module = (() => {
  ...
  return function(moduleArg = {}) {
    ...
    function findWasmBinary() {
      ...
      return new URL("" + new URL("wa-sqlite-CIFlBQuC.wasm", import.meta.url).href, import.meta.url).href;
    }
    var wasmBinaryFile;
