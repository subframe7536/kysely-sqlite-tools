import { A as __exportAll, D as init_defineProperty, E as _defineProperty, O as __commonJSMin, h as init_FacadeVFS_XQtZprLW, j as __toCommonJS, k as __esmMin, n as SQLITE_DETERMINISTIC, r as SQLITE_DIRECTONLY, t as FacadeVFS } from "./FacadeVFS-XQtZprLW-0G3Zn85o.js";
...
function customFunction(sqlite, db, fnName, fn, options = {}) {
	let flags = 1;
	if (options.deterministic) flags |= SQLITE_DETERMINISTIC;
	if (options.directOnly) flags |= SQLITE_DIRECTONLY;
...
const require_utils = (/* @__PURE__ */ __commonJSMin(((exports) => {
	...
	*/
	...
	function createSqliteExecutor(db) {
		return {
			db,
			query: async (_isSelect, sql, parameters) => ({ rows: await (0, _subframe7536_sqlite_wasm.query)(db, sql, parameters) }),
			close: async () => await (0, _subframe7536_sqlite_wasm.close)(db),
			iterator: (_isSelect, sql, parameters, chunkSize) => (0, _subframe7536_sqlite_wasm.iterator)(db, sql, parameters, chunkSize)
		};
	}
