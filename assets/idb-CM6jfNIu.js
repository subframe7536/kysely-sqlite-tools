import { C as init_assertClassBrand, D as init_defineProperty, E as _defineProperty, S as _assertClassBrand, T as init_classPrivateMethodInitSpec, _ as init_classPrivateFieldSet2, a as SQLITE_IOCAP_UNDELETABLE_WHEN_OPEN, b as _classPrivateFieldInitSpec, c as SQLITE_IOERR_CLOSE, d as SQLITE_IOERR_FSYNC, f as SQLITE_IOERR_LOCK, g as _classPrivateFieldSet2, h as init_FacadeVFS_XQtZprLW, i as SQLITE_IOCAP_BATCH_ATOMIC, k as __esmMin, l as SQLITE_IOERR_DELETE, m as SQLITE_IOERR_UNLOCK, o as SQLITE_IOERR_ACCESS, p as SQLITE_IOERR_TRUNCATE, s as SQLITE_IOERR_CHECKRESERVEDLOCK, t as FacadeVFS, u as SQLITE_IOERR_FSTAT, v as _classPrivateFieldGet2, w as _classPrivateMethodInitSpec, x as init_classPrivateFieldInitSpec, y as init_classPrivateFieldGet2 } from "./FacadeVFS-XQtZprLW-0G3Zn85o.js";
//#region ../node_modules/.pnpm/@subframe7536+sqlite-wasm@1.3.0/node_modules/@subframe7536/sqlite-wasm/dist/wa-sqlite-async-DXJkldif.js
var Module;
var init_wa_sqlite_async_DXJkldif = __esmMin((() => {
	init_defineProperty();
	Module = (() => {
...
//#endregion
//#region ../node_modules/.pnpm/@subframe7536+sqlite-wasm@1.3.0/node_modules/@subframe7536/sqlite-wasm/dist/WebLocksMixin-GJSIWwOL.js
var SHARED, POLL_SHARED, POLL_EXCLUSIVE, POLICIES, WebLocksMixin;
var init_WebLocksMixin_GJSIWwOL = __esmMin((() => {
...
//#endregion
//#region ../node_modules/.pnpm/@subframe7536+sqlite-wasm@1.3.0/node_modules/@subframe7536/sqlite-wasm/dist/idb.js
...
var _isReady, _idb, _IDBBatchAtomicVFS_brand, _database, _chain, _txComplete, _request, _txPending, _IDBContext_brand, RETRYABLE_ERRORS, File, IDBBatchAtomicVFS, IDBContext;
//#endregion
__esmMin((() => {
	init_FacadeVFS_XQtZprLW();
	init_wa_sqlite_async_DXJkldif();
	init_WebLocksMixin_GJSIWwOL();
	init_defineProperty();
	init_classPrivateMethodInitSpec();
	init_classPrivateFieldInitSpec();
	...
	init_assertClassBrand();
	init_classPrivateFieldGet2();
	RETRYABLE_ERRORS = /* @__PURE__ */ new Set(["TransactionInactiveError", "InvalidStateError"]);
	File = class {
	...
	IDBBatchAtomicVFS = (_isReady = /* @__PURE__ */ new WeakMap(), _idb = /* @__PURE__ */ new WeakMap(), _IDBBatchAtomicVFS_brand = /* @__PURE__ */ new WeakSet(), class IDBBatchAtomicVFS extends WebLocksMixin(FacadeVFS) {
		...
		constructor(name, module, options = {}) {
			super(name, module, options);
			_classPrivateMethodInitSpec(this, _IDBBatchAtomicVFS_brand);
			_defineProperty(
				this,
			...
			_classPrivateFieldSet2(_isReady, this, _assertClassBrand(_IDBBatchAtomicVFS_brand, this, _initialize).call(this, options.idbName ?? name));
		}
		close() {
	...
	IDBContext = (_database = /* @__PURE__ */ new WeakMap(), _chain = /* @__PURE__ */ new WeakMap(), _txComplete = /* @__PURE__ */ new WeakMap(), _request = /* @__PURE__ */ new WeakMap(), _txPending = /* @__PURE__ */ new WeakMap(), _IDBContext_brand = /* @__PURE__ */ new WeakSet(), class IDBContext {
