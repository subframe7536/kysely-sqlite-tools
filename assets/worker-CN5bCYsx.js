			...
			try {
				...
				switch (message.type) {
					...
					case "stream":
						...
						streams.set(message.streamId, db.iterator(message.isSelect, message.sql, message.parameters));
...
//#endregion
//#region ../packages/dialect-wasqlite-worker/dist/utils-Ch4-QSRa.js
/**
...
const defaultCreateDatabaseFn = async ({ fileName, url, useOPFS }) => {
	return initSQLiteCore((useOPFS ? (await import("./opfs-BcRGo14-.js")).useOpfsStorage : (await import("./idb-DpkgvncT.js")).useIdbStorage)(fileName, { url }));
};
/**
