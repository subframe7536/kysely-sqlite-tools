...
var _Class_brand, _module, _array, _Class_brand2, _module2, _type, _view, _Class_brand3, _Symbol$iterator, SQLITE_IOERR_ACCESS, SQLITE_IOERR_CHECKRESERVEDLOCK, SQLITE_IOERR_CLOSE, SQLITE_IOERR_DELETE, SQLITE_IOERR_FSTAT, SQLITE_IOERR_FSYNC, SQLITE_IOERR_LOCK, SQLITE_IOERR_TRUNCATE, SQLITE_IOERR_UNLOCK, SQLITE_OPEN_TRANSIENT_DB, SQLITE_OPEN_MAIN_JOURNAL, SQLITE_OPEN_TEMP_JOURNAL, SQLITE_OPEN_SUBJOURNAL, SQLITE_OPEN_SUPER_JOURNAL, SQLITE_OPEN_WAL, SQLITE_IOCAP_UNDELETABLE_WHEN_OPEN, SQLITE_IOCAP_BATCH_ATOMIC, SQLITE_DETERMINISTIC, SQLITE_DIRECTONLY, DEFAULT_SECTOR_SIZE, Base, AsyncFunction, FacadeVFS, Uint8ArrayProxy, DataViewProxy;
var init_FacadeVFS_XQtZprLW = __esmMin((() => {
	init_defineProperty();
	...
	FacadeVFS = (_Class_brand = /* @__PURE__ */ new WeakSet(), class extends Base {
		/**
		* @param {string} name 
		* @param {object} module 
		*/
	...
	Uint8ArrayProxy = (_module = /* @__PURE__ */ new WeakMap(), _array = /* @__PURE__ */ new WeakMap(), _Class_brand2 = /* @__PURE__ */ new WeakSet(), _Symbol$iterator = Symbol.iterator, class {
		/**
		* @param {*} module
		* @param {number} byteOffset 
		* @param {number} byteLength 
	...
	DataViewProxy = (_module2 = /* @__PURE__ */ new WeakMap(), _type = /* @__PURE__ */ new WeakMap(), _view = /* @__PURE__ */ new WeakMap(), _Class_brand3 = /* @__PURE__ */ new WeakSet(), class {
		/**
		* @param {*} module
		* @param {number} byteOffset 
		* @param {'Int32'|'BigInt64'} type
...
//#endregion
export { __exportAll as A, init_assertClassBrand as C, init_defineProperty as D, _defineProperty as E, __commonJSMin as O, _assertClassBrand as S, init_classPrivateMethodInitSpec as T, init_classPrivateFieldSet2 as _, SQLITE_IOCAP_UNDELETABLE_WHEN_OPEN as a, _classPrivateFieldInitSpec as b, SQLITE_IOERR_CLOSE as c, SQLITE_IOERR_FSYNC as d, SQLITE_IOERR_LOCK as f, _classPrivateFieldSet2 as g, init_FacadeVFS_XQtZprLW as h, SQLITE_IOCAP_BATCH_ATOMIC as i, __toCommonJS as j, __esmMin as k, SQLITE_IOERR_DELETE as l, SQLITE_IOERR_UNLOCK as m, SQLITE_DETERMINISTIC as n, SQLITE_IOERR_ACCESS as o, SQLITE_IOERR_TRUNCATE as p, SQLITE_DIRECTONLY as r, SQLITE_IOERR_CHECKRESERVEDLOCK as s, FacadeVFS as t, SQLITE_IOERR_FSTAT as u, _classPrivateFieldGet2 as v, _classPrivateMethodInitSpec as w, init_classPrivateFieldInitSpec as x, init_classPrivateFieldGet2 as y };
