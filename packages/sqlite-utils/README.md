...
function getOrSetDBVersion(
  db: DatabaseConnection | Kysely<any> | Transaction<any>,
  version?: number,
): Promise<number>

// optimize pragma (typesafe `journal_mode`, `synchoronous`...)
function optimzePragma(
  conn: DatabaseConnection | Kysely<any> | Transaction<any>,
...
function createPrecompile<T extends Record<string, any>>(
...
function createSoftDeleteExecutorFn<DB extends Record<string, any>>(
